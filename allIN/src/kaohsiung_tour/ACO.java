...
public class ACO {
    ...
    private final double alpha = 1; // 賀爾蒙重要性
    private final double beta = 2; // 距離重要性
	private final double c = 10; // 初始賀爾蒙濃度
	private final double evaporation = 0.8; // 賀爾蒙衰退參數，可設為0.8 ~ 0.9之間
	private final double Q = 100; // 賀爾蒙強度
	private final double antFactor = 1; // 螞蟻的數量，建議 螞蟻數量 = 節點總數量
	
	private final int maxIterator = 100; // 執行次數
